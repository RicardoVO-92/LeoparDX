  ...
  obtenerPerfilFisico() {
    ...
    collectionData(q, { idField: 'id' }).subscribe((data: any[]) => {
      if (data.length > 0) {
        ...
        this.perfilFisicoDocId = perfil.id || '';
        this.perfilFisico.id = perfil.id || '';
        this.perfilFisico.peso = perfil.peso ?? 0;
        this.perfilFisico.altura = perfil.altura ?? 0;
        this.perfilFisico.objetivo = perfil.objetivo || '';
        this.perfilFisico.nivelActividad = perfil.nivelActividad || '';
        this.perfilFisico.registradoEn = perfil.registradoEn || '';
